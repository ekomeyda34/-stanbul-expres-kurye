...
const updatePriceDisplay = (distanceKm) => {
    ...
    whatsappLink.href = `https://wa.me/905052087761?text=${encodeURIComponent(msg)}`;
};
...
// Numaralar
const phoneNum1 = "05052087761"; // Hat 1
const phoneNum2 = "05052087761"; // Hat 2 (Mevcut)

// Ülke kodu eklenmiş hali (WhatsApp için)
const waNum1 = "05052087761";
const waNum2 = "05052087761";
